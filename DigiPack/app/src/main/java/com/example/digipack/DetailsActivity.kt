...
class DetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Button that goes to the google classroom page
        var gclassIntent = Intent(this, gClassActivity::class.java)
        val gclassButton = findViewById<Button>(R.id.google_classroom_btn)
        gclassButton.setOnClickListener(){
            this.startActivity(gclassIntent)
        }

        // Button that goes to the google search page
        var gsearchIntent = Intent(this, gSearchActivity::class.java)
        val gsearchButton = findViewById<Button>(R.id.google_search_btn)
        gsearchButton.setOnClickListener(){
